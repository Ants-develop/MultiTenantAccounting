...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['api'])) {
    ...
    // Debug logging
    error_log('Spec Seller Invoices - Received parameters:');
    ...
    try {
        ...
        $sql = 'SELECT EXTERNAL_ID, F_SERIES, F_NUMBER, OPERATION_DT, SELLER_UN_ID, BUYER_UN_ID, STATUS, 
                ...
                BUYER_FOREIGNER
                FROM rs.spec_seller_invoices WHERE 1=1';
        $params = [];
...
// --- HTML Page for NSAF Seller Invoices ---
if (!isLoggedIn()) {
...
<head>
    ...
    <title>NSAF გაყიდვის ინვოისები</title>
...
document.addEventListener('DOMContentLoaded', function() {
    const colDefs = [
        ...
        // 13. საქონლის რაოდენობა (კგ) (Goods Quantity (kg)) - using NUMBER_KG
        ...
        // 21. მყიდველი უცხოელია (Buyer is Foreigner) - using BUYER_FOREIGNER
    ...
    document.getElementById('exportCsvBtn').addEventListener('click', function() {
        const pageName = 'NSAF_Seller_Invoices';
    ...
    function fetchData() {
        ...
        let url = 'spec_seller_invoices.php?api=1';
