...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['api'])) {
    ...
    try {
        ...
        $sql = 'SELECT 
            ID, WAYBILL_NUMBER as WAYBILL_ID, 
            -- Waybill fields
            ...
            [TRANSPORT_COAST], [CAR_NUMBER], [RECEPTION_INFO], [RECEIVER_INFO],
            [FULL_AMOUNT], [WAYBILL_NUMBER], [TRAN_COST_PAYER], [TRANS_ID], [TRANS_TXT],
            [IS_CONFIRMED], [STATUS], [CONFIRMED_DT], [CANCEL_DATE], [WAYBILL_COMMENT], [UNIT_TXT],
        ...
        FROM rs.buyers_waybill_goods WHERE 1=1';
        $params = [];
        ...
        error_log('Buyer waybill goods query executed successfully');
...
<head>
    ...
    <title>შესყიდვის ზედნადებები საქონლით</title>
...
<div class="container-fluid px-4 mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4>შესყიდვის ზედნადებები საქონლით - სრული სქემა</h4>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const colDefs = [
        ...
        { headerName: "მყიდველი კომპანიის სახელი", field: "COMPANY_NAME", width: 200, sortable: true, filter: true, pinned: 'left' },
        ...
        { headerName: "გამყიდველი კომპანია", field: "NAME", width: 250, sortable: true, filter: true, pinned: 'left' },
        { headerName: "გამყიდველის საიდ. ნომერი", field: "TIN", width: 130, sortable: true, filter: true, pinned: 'left' },
    ...
    function fetchData() {
        ...
        let url = 'buyer_waybills_goods.php?api=1';
    ...
    document.getElementById('exportCsvBtn').addEventListener('click', function() {
        const pageName = 'Buyer_Waybills_Goods';
