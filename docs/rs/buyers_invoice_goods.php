...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['api'])) {
    ...
    try {
        ...
        // Query only buyers invoice goods
        $sql = 'SELECT 
            ID, INVOICE_ID,
        ...
        error_log('Buyers invoice goods query executed successfully');
...
// --- HTML Page for Buyers Invoice Goods ---
if (!isLoggedIn()) {
...
<head>
    ...
    <title>შესყიდული ანგარიშ-ფაქტურების საქონელი</title>
...
<div class="container-fluid px-4 mt-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4>
            <span class="buyer-badge">მყიდველი</span>
            შესყიდული ანგარიშ-ფაქტურების საქონელი
        </h4>
        <div>
    ...
    <div id="buyersInvoiceGoodsGrid" class="ag-theme-quartz" style="height: 70vh; width: 100%;"></div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Column definitions for buyers invoice goods
    const colDefs = [
    ...
    const gridDiv = document.getElementById('buyersInvoiceGoodsGrid');
    let gridApi = null;
    const gridOptions = {
        columnDefs: colDefs,
        defaultColDef: {
    ...
    function fetchData() {
        ...
        let url = 'buyers_invoice_goods.php?api=1';
    ...
    document.getElementById('exportCsvBtn').addEventListener('click', function() {
        const pageName = 'Buyers_Invoice_Goods';
