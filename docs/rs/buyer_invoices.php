...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['api'])) {
    ...
    try {
        ...
        $sql = 'SELECT INVOICE_ID, F_SERIES, F_NUMBER, OPERATION_DT, REG_DT, SELLER_UN_ID, BUYER_UN_ID, STATUS, SEQ_NUM_S, SEQ_NUM_B, S_USER_ID, K_ID, WAS_REF, SA_IDENT_NO, ORG_NAME, NOTES, TANXA, VAT, AGREE_DATE, COMPANY_NAME, COMPANY_TIN, OVERHEAD_NO, OVERHEAD_DT, R_UN_ID, DEC_STATUS, DECL_DATE FROM rs.buyer_invoices WHERE 1=1';
        $params = [];
...
<head>
    ...
    <title>შესყიდვის ანგარიშ-ფაქტურები</title>
...
<body>
    ...
    <div class="container-fluid px-4 mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4>შესყიდვის ანგარიშ-ფაქტურები</h4>
...
document.addEventListener('DOMContentLoaded', function() {
    const colDefs = [
        ...
        { headerName: "მყიდველის დეკლარაციის ნომერი", field: "SEQ_NUM_B", sortable: true, filter: true, width: 180 },
        ...
        { headerName: "გამყიდველის სახელი", field: "ORG_NAME", sortable: true, filter: true, flex: 1 },
        { headerName: "გამყიდველის საიდ.", field: "SA_IDENT_NO", sortable: true, filter: true, width: 150 },
        { headerName: "თანხა", field: "TANXA", sortable: true, filter: 'agNumberColumnFilter', width: 120, valueFormatter: params => (params.value !== null && params.value !== undefined) ? parseFloat(params.value).toFixed(2) : '0.00' },
        { headerName: "დღგ", field: "VAT", sortable: true, filter: 'agNumberColumnFilter', width: 100, valueFormatter: params => (params.value !== null && params.value !== undefined) ? parseFloat(params.value).toFixed(2) : '0.00' },
        ...
        { headerName: "მყიდველი", field: "COMPANY_NAME", sortable: true, filter: true, flex: 1 },
        { headerName: "მყიდველის საიდ.", field: "COMPANY_TIN", sortable: true, filter: true, width: 150 },
    ...
    function fetchData() {
        ...
        let url = 'buyer_invoices.php?api=1';
