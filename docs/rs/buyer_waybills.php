...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['api'])) {
    ...
    try {
        ...
        $params = [];
            ...
            if (!empty($companies)) {
                if (count($companies) === 1) {
                    ...
                    $sql .= ' AND BUYER_TIN IN (' . implode(', ', $placeholders) . ')';
                }
            }
        }
        ...
        error_log('[DEBUG] Attempting to execute SQL query for buyer waybills');
...
<head>
    ...
    <title>შემოსავლის ზედნადებები</title>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const gridOptions = {
        ...
        onCellClicked: function(params) {
            ...
            if (params.column.colId === 'EXTERNAL_ID' && params.value) {
                waybillDetailModal.show(params.value, 'buyer');
                return;
            }
    ...
    function fetchData() {
        ...
        let url = 'buyer_waybills.php?api=1';
