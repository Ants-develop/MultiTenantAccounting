...
export const ACTIVITY_ACTIONS = {
  ...
  FEED_POST_UPDATE: 'FEED_POST_UPDATE',
  FEED_POST_DELETE: 'FEED_POST_DELETE',
  FEED_POST_PIN: 'FEED_POST_PIN',
  FEED_POST_LIKE: 'FEED_POST_LIKE',
  FEED_COMMENT_CREATE: 'FEED_COMMENT_CREATE',
  FEED_COMMENT_UPDATE: 'FEED_COMMENT_UPDATE',
  ...
  BACKUP_UPLOAD_TO_STORAGE: 'BACKUP_UPLOAD_TO_STORAGE',
  BACKUP_DELETE_FROM_STORAGE: 'BACKUP_DELETE_FROM_STORAGE',
  BACKUP_RESTORE_FROM_DRIVE: 'BACKUP_RESTORE_FROM_DRIVE',
  BACKUP_RESTORE_FROM_STORAGE: 'BACKUP_RESTORE_FROM_STORAGE',
